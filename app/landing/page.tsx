  ...
  return (
    ...
    >
      <div className="relative overflow-hidden">
          ...
          <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-4 lg:px-8">
            <div className="flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-xl bg-[var(--ink)] text-[var(--amber)]">
                <span className={`${displayFont.className} text-lg`}>S</span>
              </div>
              <div>
                <p
        ...
        <main id="main-content" className="mx-auto max-w-6xl px-4 lg:px-8">
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div className="order-2 lg:order-1 relative">
                <div className="relative rounded-[32px] bg-neutral-100 border border-black/5 overflow-hidden aspect-[4/3] flex items-center justify-center">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] border border-black/5 rounded-full animate-[spin_10s_linear_infinite] pointer-events-none border-dashed opacity-20"></div>
                </div>
              </div>
              <div className="order-1 lg:order-2 px-4">
              ...
              <div className="space-y-4">
                {flowSteps.map((step) => (
                  <button
                    ...
                    className={`group w-full rounded-[32px] border px-8 py-6 text-left transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--amber)] ${
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {useCases.map((item, i) => (
                <div key={item.title} className="group cursor-default">
                  <div className="h-1 w-12 bg-black/10 mb-6 group-hover:w-full group-hover:bg-[var(--amber)] transition-all duration-500"></div>
          ...
          <section id="faq" className="py-24 scroll-mt-24">
            <h2
              className={`${displayFont.className} text-4xl uppercase tracking-wide mb-12`}
            >
              Common Questions
            </h2>
            <div className="grid gap-6 md:grid-cols-2">
              {faqs.map((item) => (
                <div
                  key={item.q}
                  className="p-8 rounded-[32px] bg-neutral-50 hover:bg-white border border-transparent hover:border-black/5 transition-all"
                >
          ...
          <section id="cta" className="py-32 text-center">
            <h2
              className={`${displayFont.className} text-[12vw] leading-[0.8] uppercase tracking-tighter text-black opacity-10 select-none pointer-events-none`}
            >
              Game On
            </h2>
            <div className="-mt-12 relative z-10">
              <h3
                className={`${displayFont.className} text-5xl md:text-7xl uppercase tracking-wide mb-8`}
              >
                Ready to play?
              </h3>
              <Link
                href="/"
                className="inline-flex h-16 items-center justify-center rounded-full bg-[var(--amber)] px-10 text-xs font-bold uppercase tracking-[0.3em] text-black shadow-xl shadow-amber-500/30 transition-transform hover:-translate-y-1 hover:shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black"
              >
                Start Match Now
              </Link>
            </div>
      ...
      <footer className="border-t border-black/10 bg-white/70">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-6 text-xs text-black/60 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.35em]">
            Scorehub
